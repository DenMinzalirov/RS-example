export const mainPages = [
    {
        wordGroup: 'Action (set A)',
        imgGroup: './img/dance.jpg',
        name: 'actionSetA',
    },
    {
        wordGroup: 'Action (set B)',
        imgGroup: './img/swim.jpg',
        name: 'actionSetB',
    },
    {
        wordGroup: 'Action (set C)',
        imgGroup: './img/drop.jpg',
        name: 'actionSetC',
    },
    {
        wordGroup: 'Adjective',
        imgGroup: './img/friendly.jpg',
        name: 'adjective',
    },
    {
        wordGroup: 'Animal (set A)',
        imgGroup: './img/cat.jpg',
        name: 'animalSetA',
    },
    {
        wordGroup: 'Animal (set B)',
        imgGroup: './img/bird.jpg',
        name: 'animalSetB',
    },
    {
        wordGroup: 'Clothes',
        imgGroup: './img/blouse.jpg',
        name: 'clothes',
    },
    {
        wordGroup: 'Emotion',
        imgGroup: './img/smile.jpg',
        name: 'emotion',
    },
]

export const actionSetA = [
    {
        word: 'cry',
        translation: 'плакать',
        image: './img/cry.jpg',
